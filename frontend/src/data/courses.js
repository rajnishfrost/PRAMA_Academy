export const courses = [
  {
    ...
    levels: [
      {
        title: 'Foundation Level (1 to 5)',
        desc: 'Students learn basic abacus concepts, manipulate beads for addition and subtraction of single-digit numbers, and are introduced to mental abacus training.',
      },
      {
        title: 'Advanced Level (6 & 7)',
        desc: 'Students move on to complex calculations with multiple-digit numbers, including multiplication and division using the abacus and mental math.',
      },
      {
        title: 'Grand Master Level (8 & 9)',
        desc: 'Advanced techniques for quick and accurate calculations including decimals, negative numbers and BODMAS concepts.',
      },
      {
        title: 'Master of Mental Math (M1 & M2)',
        desc: 'Special level for kids who achieved grand master position - revision of techniques and practicing higher problems mentally.',
      },
      {
        title: 'Competition Level',
        desc: 'Specialized training focused on speed and accuracy, preparing students for abacus competitions.',
      },
    ],
    programs: [
      {
  ...
  },
  {
    ...
    levels: [
      {
        title: 'Level 1',
        desc: 'Subtraction & Vinculum, Multiplication techniques including squares, multiplication by 11, 99, 999, base multiplication, and vertical crosswise multiplication.',
      },
      {
        title: 'Level 2',
        desc: 'High speed addition & subtraction, flag method division, squaring, square root, cubes, cube root, dates & calendars, ratio & proportion.',
      },
      {
        title: 'Level 3',
        desc: 'Auxiliary division, divisibility test, Pythagoras theorem, factorization, linear equations, algebraic operations, remainder theorem.',
      },
    ],
    programs: [
      {
  ...
  },
  {
    ...
    levels: [
      {
        title: 'Basic Level',
        desc: '16 daily-use shlokas in 3-4 months. Kids are also introduced to mythological stories and bhajans.',
      },
      {
        title: 'Advanced Level',
        desc: 'Along with shloka, bhajan, chalisa, sahasranaam of various gods and puranas are taught.',
      },
    ],
    programs: [
      {
