    ...
    courseBenefits : [
                      {
                       ...
                       description : "Learning to use an abacus helps children develop strong mathematical skills, including mental calculation, problem-solving, and understanding of number concepts. This can lead to improved performance in mathematics and related subjects."
                      } ,
                      {
                        heading : "Improved Concentration:" ,
                       description : "Manipulating the abacus beads requires concentration and focus. Regular practice can enhance a child&#39;s attention span, which is beneficial for overall cognitive development."
                      }
                     ] ,
    courTeacher: [
      {
